...
export default function LandingPage({ onEnterApp }: LandingPageProps) {
  ...
  return (
    <div id="landing-page-root" className="min-h-screen bg-[#0a0a0a] text-neutral-100 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden">
      ...
      <header className="border-b border-white/10 bg-[#0a0a0a]/85 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-18 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center font-bold text-xl text-white shadow-lg shadow-blue-500/20">
              <span>R</span>
            </div>
            <span className="font-semibold text-xl tracking-tight text-white">Restaurant<span className="text-blue-400">OS</span></span>
            <span className="text-[10px] bg-white/5 border border-white/10 text-neutral-400 px-2 py-0.5 rounded-full font-mono font-medium ml-2 uppercase">Latam v4.0</span>
          </div>

          <nav className="hidden md:flex items-center gap-8 text-sm text-neutral-400 font-medium">
            <span className="text-white hover:text-white cursor-pointer transition-colors">Producto</span>
            <span className="hover:text-white cursor-pointer transition-colors">Módulos</span>
            <span className="hover:text-white cursor-pointer transition-colors">Planes</span>
            <span className="hover:text-white cursor-pointer transition-colors">Empresa</span>
          </nav>
      ...
      <section className="relative pt-24 pb-20 overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-neutral-900/80 via-[#0a0a0a] to-[#0a0a0a]">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 px-3 py-1 rounded-full text-blue-400 text-xs font-semibold mb-6 uppercase tracking-wider">
            ...
            SaaS Premium para Latinoamérica
          </div>
          ...
          <p className="text-lg sm:text-xl text-neutral-400 max-w-3xl mx-auto mb-10 leading-relaxed">
            Pedidos, mesas interactiva, KDS para cocina, almacén inteligente, CRM de clientes, personal, facturación electrónica autorizada por el SRI y predicciones con Inteligencia Artificial. Todo integrado, robusto e instantáneo.
          </p>
            ...
            <div className="flex h-full flex-col md:flex-row gap-6">
              ...
              <div className="flex-1 text-left">
                <div className="flex justify-between items-center mb-6 pt-2">
                  <h3 className="text-base font-bold text-white">Panel de Control Principal</h3>
                  <div className="flex gap-2">
                    <span className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2.5 py-0.5 rounded text-[10px] font-mono">Abierto: Turno Almuerzo</span>
                    <span className="bg-white/5 text-neutral-400 px-2.5 py-0.5 rounded text-[10px] font-mono">Facturación SRI: Conectado</span>
                  </div>
                </div>
      ...
      <section id="problemas" className="py-24 border-t border-white/10 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-xs font-bold text-blue-400 uppercase tracking-widest block mb-2">La Realidad Restaurantera</span>
            <p className="text-3xl sm:text-4xl font-extrabold text-white">¿Por qué fallan los sistemas tradicionales?</p>
            <p className="text-neutral-400 mt-4">Un restaurante promedio pierde hasta un 18% de sus ganancias anuales debido a ineficiencias analógicas, robo hormiga o softwares fragmentados que no se integran.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="border border-white/10 bg-[#161616]/40 p-6 rounded-2xl hover:border-white/20 transition-all group">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Desperdicios y Merma</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">Sin recetas restadas del almacén en tiempo real al vender, es imposible detener las mermas o el desabasto de ingredientes.</p>
            </div>
            ...
            <div className="border border-white/10 bg-[#161616]/40 p-6 rounded-2xl hover:border-white/20 transition-all group">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Caos en Cocina</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">Comandas de papel extraviadas, cocineros confundidos y demoras de despacho que minan la reputación de tu negocio.</p>
            </div>
            ...
            <div className="border border-white/10 bg-[#161616]/40 p-6 rounded-2xl hover:border-white/20 transition-all group">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Cero Decisiones Con Datos</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">No conocer con precisión qué platos gozan de mejor margen neto te obliga a comprar basándote en suposiciones.</p>
            </div>
            ...
            <div className="border border-white/10 bg-[#161616]/40 p-6 rounded-2xl hover:border-white/20 transition-all group">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Multas Administrativas</h3>
              <p className="text-xs text-neutral-400 leading-relaxed">Retrasos o errores humanos al facturar electrónicamente al SRI, lo que provoca multas del Servicio de Rentas Internas.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="roi" className="py-24 border-t border-white/10 bg-[#161616]/20 relative">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="col-span-1 lg:col-span-7 bg-[#0d0d0d] border border-white/10 md:p-8 p-6 rounded-3xl shadow-2xl relative overflow-hidden">
              ...
              <div className="mt-8 pt-6 border-t border-white/10 grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div className="bg-blue-500/5 p-4 rounded-xl border border-blue-500/20 text-center relative overflow-hidden">
                  <span className="text-[10px] text-blue-300 font-bold uppercase block mb-1 font-mono">Retorno Anual Net</span>
      ...
      <section className="py-16 bg-[#0a0a0a] text-center relative border-t border-white/10">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="flex justify-center gap-3 mb-6 flex-wrap">
            <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest px-3 py-1 bg-white/5 rounded-full border border-white/10">🇪🇨 Conectado con SRI Ecuador</span>
            <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest px-3 py-1 bg-white/5 rounded-full border border-white/10">⚡ Touch Screen POS ready</span>
            <span className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest px-3 py-1 bg-white/5 rounded-full border border-white/10">🤖 Analítica Predictiva</span>
          </div>
          <h3 className="text-lg font-bold text-white">Cumpliendo con los más estrictos estándares del sector restaurantero</h3>
          <p className="text-xs text-neutral-400 mt-2 max-w-2xl mx-auto font-medium">
            Compatible con ticketera térmica, balanza de cocina, cajón inteligente de monedas de curso legal y enrutador de pedidos omnicanal.
          </p>
        </div>
      </section>
      ...
      <footer className="bg-[#0a0a0a] border-t border-white/10 py-12 text-neutral-500 text-sm">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="bg-blue-600 text-white w-7 h-7 rounded-lg font-bold flex items-center justify-center text-xs">
              R
            </div>
          ...
          <div className="text-xs text-neutral-600 font-mono flex items-center gap-2">
            ...
            <span>Infraestructura Cloud Run Latinoamérica • Clúster de Alto Rendimiento</span>
          </div>
        </div>
      </footer>
